...
const SERVICES = [
  {
    ...
    duration: "5 – 10 дней",
    from: "от 180 000 ₽",
    img: asset("/portfolio/range-rover-sv-l460-craft-2.jpg"),
  },
  {
    num: "02",
    ...
    duration: "10 – 14 дней",
    from: "от 320 000 ₽",
    img: asset("/portfolio/bmw-xm-label-red-0.jpg"),
  },
  {
    num: "03",
    ...
    duration: "2 – 3 дня",
    from: "от 90 000 ₽",
    img: asset("/portfolio/porsche-taycan-turbo-s-craft-4.jpg"),
  },
  {
    num: "04",
    ...
    duration: "4 – 7 дней",
    from: "от 140 000 ₽",
    img: asset("/portfolio/audi-rs6-avant-performance-craft-4.jpg"),
  },
  {
    num: "05",
    ...
    duration: "1 – 2 дня",
    from: "от 25 000 ₽",
    img: asset("/portfolio/aston-martin-dbs-770-ultimate-det-2.jpg"),
  },
  {
    num: "06",
    ...
    duration: "2 – 4 дня",
    from: "от 45 000 ₽",
    img: asset("/portfolio/bentley-flying-spur-mulliner-2.jpg"),
  },
];
  ...
  return (
    <div>
      <PageHero
        ...
        image={asset("/portfolio/mclaren-765lt-0.jpg")}
      />
