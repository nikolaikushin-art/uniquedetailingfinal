  ...
  return (
    <div>
      <PageHero
        ...
        image={asset("/portfolio/maserati-mc20-cielo-0.jpg")}
      />
        ...
        <div className="mx-auto max-w-[1280px]">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            {[
              ...
              {
                name: "Gold",
                desc: "После двух работ или комплексной оклейки PPF.",
      ...
      <section className="relative overflow-hidden border-y border-line py-32 text-center">
        <div
          ...
          style={{
            backgroundImage: `url(${asset("/portfolio/maserati-grecale-trofeo-craft-6.jpg")})`,
          }}
        />
