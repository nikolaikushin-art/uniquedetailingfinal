...
function KlubPage() {
  return (
    <div>
      ...
      {/* Отсылка к общим привилегиям — чтобы не дублировать их здесь */}
      <section className="px-[6vw] pb-8">
        <p className="mx-auto max-w-[900px] text-center text-[14.5px] leading-[1.9] text-mute">
          Забор и доставка автомобиля, такси бизнес-класса, ежедневный видеоотчёт, гарантия и
          персональная карточка автомобиля доступны{" "}
          <span className="text-ivory">всем клиентам студии</span> — см.{" "}
          <Link to="/privilegii" className="text-ivory underline-offset-4 hover:underline">
            ...
            {[
              {
                ...
                perks: ["Приоритетная запись", "Скидки на дополнительные услуги"],
              },
              {
                name: "Gold",
