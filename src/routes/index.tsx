...
const HOME = {
  heroPoster: asset("/portfolio/mercedes-benz-g-63-amg-0.jpg"),
  studio: asset("/portfolio/rolls-royce-phantom-series-ii-craft-1.jpg"),
  services: asset("/portfolio/porsche-911-turbo-s-craft-3.jpg"),
  film: asset("/portfolio/lamborghini-revuelto-craft-2.jpg"),
  quote: asset("/portfolio/ferrari-roma-det-6.jpg"),
};
      ...
      >
        <div className="grid gap-14 md:grid-cols-[0.9fr_1.1fr] md:items-center md:gap-20">
          ...
          <div className="space-y-6 text-[15.5px] leading-[1.95] text-mute">
            <p>
              Премиальная детейлинг-студия с европейским уровнем сервиса, работающая по проверенным
              временем стандартам.
            </p>
            <p>
              Более 10 лет опыта, сотни проектов и команда, которая по-настоящему любит автомобили.
            </p>
          </div>
        </div>
      </Section>
