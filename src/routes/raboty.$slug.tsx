...
const GALLERY_TABS = [
  ...
  { key: "interior", label: "Интерьер", indices: [6, 7, 8, 9, 10, 11] },
  { key: "detail", label: "Деталь", indices: [12, 13, 14, 15, 16, 17] },
  { key: "craft", label: "Мастерство", indices: [18, 19, 20, 21, 22, 23] },
] as const;
