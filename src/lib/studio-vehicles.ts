...
const ROWS: VehicleRow[] = [
  ...
  { brand: "Maserati", model: "MC20 Cielo", category: "PPF", tagline: "Maserati MC20 Cielo: среднемоторное купе-тарга Модены, глубокий синий кузов и один комплект тёмных дисков во всех кадрах.", hours: "88 часов", body: "supercar", paint: "#0f2f55", paintName: "Blu Infinito", interior: "#1a1310", wheel: "#141618", year: 2025, performance: { power: "630 л.с.", torque: "730 Н·м", zeroTo: "2.9 с", top: "324 км/ч", weight: "1 540 кг" } },
  { brand: "Maserati", model: "Grecale Trofeo", category: "PPF", tagline: "Maserati Grecale Trofeo в аметистовом лаке: премиальный SUV Trident, одна спецификация и единая студийная серия.", hours: "72 часа", body: "suv", paint: "#4a2b46", paintName: "Amethyst Sunrise", interior: "#efe1cd", wheel: "#1a1c20", year: 2025, performance: { power: "530 л.с.", torque: "620 Н·м", zeroTo: "3.8 с", top: "285 км/ч", weight: "2 100 кг" } },
];
